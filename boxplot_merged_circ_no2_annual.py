...
filestem = '/nfs/see-fs-01_teaching/ee15amg/TRAJ_MODEL/AURN_data/complete/post_transfer/bin_no2_data/binned_no2_LWT_'
filestem1 = '/nfs/see-fs-01_teaching/ee15amg/TRAJ_MODEL/AURN_data/complete/post_transfer/bin_no2_data/binned_no2_kerbside_'
...
ax0.set_title('Annual NO$_{2}$ Concentrations & LWT 2010-2016 \n Background ')
...
plt.savefig('merged_lwt_no2_kerbside_background_annual.png')
plt.show()
