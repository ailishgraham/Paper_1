...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 17 13:13:48 2018
...
filestem1 = '/nfs/see-fs-01_teaching/ee15amg/TRAJ_MODEL/AURN_data/complete/post_transfer/bin_no2_data/binned_pm25_kerbside_'
...
for lwt in np.arange(len(lamb_weather_type)):
    ...
    #print('data_matrix', d)
    print('min0',np.min(d), 'max0',np.max(d))    
    print('min1',np.min(d1), 'max1',np.max(d1))
    #print(np.shape(d))
...
#    print 'flat0', d_flattened
#    print 'flat1', d1_flattened
#    print 'mean0',np.nanmean(d_flattened)
#    print 'mean1',np.nanmean(d1_flattened)
#    time.sleep(100)
...
#print 'stat',statistics[0,:] 
#print 'stat1',statistics_1[0,:] 
#time.sleep(100)
...
ax0.set_title('Annual PM$_{2.5}$ Concentrations & LWT 2010-2016 \n Background ')
...
plt.savefig('merged_lwt_pm25_kerbside_background_annual.png')
plt.show()
