...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 23 12:06:19 2018
...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 22 14:40:52 2018
...
filestem = '/nfs/see-fs-01_teaching/ee15amg/TRAJ_MODEL/AURN_data/complete/post_transfer/correl_data/binned_no2_kerbside_lats_annual_'
...
#    plt.yticks(range(len(c)), descending_lats)
    ...
    plt.title('Correlation of annual kerbside NO$_{2}$ at sites during LWT - '+str(lamb_weather_type[ilwt]))
    plt.xlabel('Site')
    plt.ylabel('Site')
    plt.tight_layout()
    plt.savefig('correlate_no2_kersite_annual_sites_nona_'+str(lamb_weather_type[ilwt]))
