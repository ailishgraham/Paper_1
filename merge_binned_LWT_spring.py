...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_uc"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_ne"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_e"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_se"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_s"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_sw"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_w"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_nw"+".csv", na_rep="NaN", index=False, encoding='utf-8')
...
print(c)
print type(c)
c.to_csv("binned_pm25_background_winter_n"+".csv", na_rep="NaN", index=False, encoding='utf-8')
