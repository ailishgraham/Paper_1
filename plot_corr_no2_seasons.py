...
filestem = '/nfs/see-fs-01_teaching/ee15amg/TRAJ_MODEL/AURN_data/complete/post_transfer/correl_data/binned_no2_background_lats_winter_'
...
#    plt.yticks(range(len(c)), descending_lats)
    ...
    plt.title('Correlation of winter NO$_{2}$ at sites during LWT - '+str(lamb_weather_type[ilwt]))
    plt.xlabel('Site')
    plt.ylabel('Site')
    plt.tight_layout()
    plt.savefig('correlate_no2_winter_sites_nona_'+str(lamb_weather_type[ilwt]))
