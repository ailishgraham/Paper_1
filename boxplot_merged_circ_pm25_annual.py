...
for lwt in np.arange(len(lamb_weather_type)):
    ...
    df = df[df.columns[2:46]]
    print 'df',df
    dfnew = df.iloc[:,[0, 2, 5, 11, 12, 14, 15, 16, 18, 19, 21, 22, 25, 26, 27, 28, 31, 32, 33, 35, 39, 40, 42, 43]]
    print 'dfnew', dfnew
    time.sleep(10)
...
plt.savefig('gd_sites_merged_lwt_pm25_kerbside_background_annual.png')
plt.show()
