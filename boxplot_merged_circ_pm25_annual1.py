...
filestem = '/nfs/see-fs-01_teaching/ee15amg/TRAJ_MODEL/AURN_data/complete/post_transfer/bin_no2_data/binned_pm25_LWT_'
...
labels0 = ['n','ne','nw','e','s','se','sw','w','uc']
labels1 = ['n','ne','nw','e','s','se','sw','w','uc']
ax0.set_xlim((-1,9))
ax0.set_ylim((0,100))
ax1.set_xlim((-1,9))
ax1.set_ylim((0,100))
